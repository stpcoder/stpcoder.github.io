...
- Every finished game opens the actual section-grouped records with readable expandable details; the permanent collection remains independently accessible by section.
